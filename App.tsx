  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50 text-slate-900 font-sans">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 h-16 flex items-center px-4 lg:px-8 justify-between sticky top-0 z-10 shrink-0">
                ...
                <div className="max-w-4xl mx-auto px-4 py-8 lg:px-12 lg:py-12">
                    {!activePath ? (
                        <div className="flex flex-col items-center justify-center h-[60vh] text-center px-4">
                            <div className="w-20 h-20 bg-primary-50 rounded-full flex items-center justify-center mb-6 text-primary-300">
                                <BookOpen size={40} />
                            </div>
                            <h2 className="text-2xl font-bold text-slate-800 mb-2">Welcome to Harvey Blocks' Space</h2>
